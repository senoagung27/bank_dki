...
<head>
    ...
    <link rel="stylesheet"
        href="{{ URL::asset('../../assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
    <link rel="stylesheet" href="{{ URL::asset('../../assets/vendor/libs/typeahead-js/typeahead.css') }}" />
    <!-- Vendor -->
    <link rel="stylesheet" href="{{ URL::asset('../../assets/vendor/libs/@form-validation/form-validation.css') }}" />
...
<body>
    ...
    <!-- Page JS -->
    <script src="{{ URL::asset('../../assets/js/pages-auth.js') }}"></script>
