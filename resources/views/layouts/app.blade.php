...
<body>
    ...
    <script src="{{ URL::asset('../../assets/vendor/libs/@form-validation/popular.js') }}"></script>
    <script src="{{ URL::asset('../../assets/vendor/libs/@form-validation/bootstrap5.js') }}"></script>
    <script src="{{ URL::asset('../../assets/vendor/libs/@form-validation/auto-focus.js') }}"></script>
    ...
    <script src="{{ URL::asset('../../assets/vendor/libs/mapbox-gl/mapbox-gl.js') }}"></script>
    <script src="{{ URL::asset('../../assets/vendor/libs/chartjs/chartjs.js') }}"></script>
    <script src="{{ URL::asset('../../assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>
    ...
    <script src="{{ URL::asset('../../assets/vendor/libs/bloodhound/bloodhound.js') }}"></script>
    <!-- Main JS -->
    <script src="{{ URL::asset('../../assets/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ URL::asset('../../assets/js/app-invoice-list.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/charts-chartjs.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/charts-apex.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/cards-analytics.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/app-ecommerce-dashboard.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/app-user-list.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/app-access-permission.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/modal-add-permission.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/modal-edit-permission.js') }}"></script>
    <script src="{{ URL::asset('../../assets/js/app-logistics-fleet.js') }}"></script>
